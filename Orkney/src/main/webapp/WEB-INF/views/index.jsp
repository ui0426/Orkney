...
<section class="mainsection">
	<div class="event row no-gutters" style="height: auto;">
		...
		<div class="banner col-md-8 col-12">
			<img src="https://www.ikea.com/images/ingatorp-20b2e2ce57f48cf53e4c986ff3ebe595.jpg?f=xxxl 1400w,
	...
	<div id="home-slider">
		<div class="swiper-container swiper-container-vertical">
			<div class="swiper-wrapper" style="transform: translate3d(0px, -1800px, 0px); transition-duration: 0ms;">
				<div class="swiper-slide swiper-slide-one swiper-slide-prev" data-swiper-slide-index="0">
					<div class="swiper-image" data-swiper-parallax-y="-20%" style="transform: translate3d(0px, -20%, 0px); transition-duration: 0ms;">
						<div class="main">
							...
							<p class="class-p">여러 이유 때문에 면은 침실과 욕실에 인기 있는 소재예요. 2015년부터
								ORKNEY는 제품에 사용하는 모든 면을 보다 지속가능한 공급처에서 제공받고 있어요. 즉, 농약과 비료를 덜 써서
								생산되는 면을 사용하고 있다는 뜻이죠. 훨씬 더 효율적인 농법과 더 나은 수자원 관리법을 개발하기 위해 여러 가지
								연구가 계속되고 있어요.</p>
						...
						<video autoplay="" loop="" class="video-background" muted="">
							<source src="${path}/resources/video/03_IKEA_sustainability_KinderCotton_5s_3x4_offline_v03_EL_Grade-1-.webm" type="video/webm">
						</video>
						</a>
					</div>
				</div>
				<div class="swiper-slide swiper-slide-one swiper-slide-prev"
					...
					<div class="swiper-image" data-swiper-parallax-y="-20%"
						...
						<div class="main">
							...
							<p class="class-p underlined">목재는 튼튼하고 오래가면서도 개성 넘치는 가구를 만들 수
								있는 훌륭한 소재예요. 사포질로 다듬고, 스테인으로 마감하거나, 페인트 칠을 하면 가구의 수명을 늘릴 수 있죠.
								결국, 나무는 완전히 새로운 질감으로 재탄생하게 됩니다.</p>
							<a class="class-a" href="${path}">IVER 이바르 시스템 보러가기</a>
						</div>
						<a href="${path}/product/productDetail.do?productno=p259"> <video
								autoplay="" loop="" class="video-background" muted="">
								<source
				...
				<div class="swiper-slide swiper-slide-one swiper-slide-prev"
					...
					<div class="swiper-image" data-swiper-parallax-y="-20%"
						...
						<div class="main">
							...
							<p class="class-p">이 제품을 사용하면 특수한 메커니즘 덕분에 일하면서도 끊임없이 몸을 움직일
								수 있어요. 이 조절식 스툴을 꾸준히 사용할 경우 근육과 척추가 강화되며 자연스럽게 건강한 자세를 취하게 됩니다.
								따라서 꼼짝 못하고 일할 때에도 계속해서 몸을 움직일 수가 있죠.</p>
							<a class="class-a" href="${path}">LIDKULLEN 리드쿨렌 보러 가기</a>
						</div>
						<a href="${path}/product/productDetail.do?productno=p256"> 
							<video autoplay="" loop="" class="video-background" muted="">
								<source src="${path}/resources/video/15_IKEA_sustainability_HealthierEveryDay_8s_3x4_offline_v02_EL_Grade (1).webm" type="video/webm">
							</video>
						</a>
					</div>
				</div>
				<div class="swiper-slide swiper-slide-one swiper-slide-prev"
					...
					<div class="swiper-image" data-swiper-parallax-y="-20%"
						...
						<div class="main">
							...
							<p class="class-p">라이프스타일이나 환경적 요인 때문에 수면의 시간이나 질이 떨어지는 경우가
								많아요. 그래서 스트레스를 관리하고 일과 생활의 균형을 향상시키는 방법을 찾는 것은 매우 중요할 수 있어요.
								침실에서 충분한 숙면을 취하려면 빛과 소리, 편안함, 공기의 질, 그리고 온도를 모두 알맞은 수준으로 유지해야
								합니다.</p>
							<a class="class-a" href="${path}">모든 싱글 침대 보러 가기</a>
						</div>
						<a href="${path}/product/products.do?category=침대&sale=&search-input=">
							<video autoplay="" loop="" class="video-background" muted="">
								<source src="${path}/resources/video/16_IKEA_sustainability_AchievingBetterSleep_5s_3x4_offline_v03_EL_Grade-1-.webm" type="video/webm">
							</video>
						</a>
					</div>
				</div>
				<div class="swiper-slide swiper-slide-one swiper-slide-prev"
					...
					<div class="swiper-image" data-swiper-parallax-y="-20%"
						...
						<div class="main">
							...
							<p class="class-p">식구가 늘어나고 라이프스타일도 변하거나 취향이 성숙해질 때, 모듈식 가구는
								아주 고마운 제품이에요. 나중에 바꿔야 할 수도 있는 가구에 많은 돈을 미리 쓸 필요 없이 필요에 따라 원하는
								모듈만 간단히 더할 수 있으니까요. 모듈식 가구를 사용하면 홈퍼니싱을 새로운 생활 환경에 맞게 합리적인 비용으로
								간편하게 조정할 수 있어요.</p>
							<a class="class-a" href="${path}">BUSUNGE 부숭에 침대 보러 가기</a>
						</div>
						<a href="${path}/product/productDetail.do?productno=p257">
							 <video autoplay="" loop="" class="video-background" muted="">
								<source src="${path}/resources/video/10_IKEA_sustainability_MoreSustainableOneStepAtTheTime_5s_3x4_offline_v02_EL_Grade (1).webm" type="video/webm">
							</video>
						</a>
					</div>
				</div>
				<div class="swiper-slide swiper-slide-one swiper-slide-prev"
					...
					<div class="swiper-image" data-swiper-parallax-y="-20%"
						...
						<div class="main">
							...
							<p class="class-p">새로운 조명, 난방 및 가전 제품으로 에너지 소비를 줄이고 돈도 아낄 수
								있어요. 현대인의 필수품인 가전 제품을 포기할 수 없다면, 에너지 효율이 뛰어난 AA+ 등급 이상의 최신 모델을
								사용하세요. 한걸음 더 나아가 지구를 생각한다면 가정용 태양광 에너지를 이용해보세요. 탄소 배출량을 줄이고 전기
								요금도 절약할 수 있을 거예요.</p>
							<a class="class-a" href="${path}">무선 LED 전구 보러 가기</a>
						</div>
						<a href="${path}/product/products.do?category=조명&sale=&search-input=">
							<video autoplay="" loop="" class="video-background" muted="">
								<source src="${path}/resources/video/07_IKEA_sustainability_SimplySustainable_5s_3x4_offline_v05_Grade (1).webm" type="video/webm">
							</video>
						</a>
					</div>
				</div>
		...
		<div class="pp-img">
			<div class="pp-img-mg-id oneClass">
				<div class="pp-img-ib tjf ">
					<a class="pp-img-a"> <img class="pp-img-wdhe" src="">
					</a>
				</div>
			</div>
...
<script> 
	...
	var mySwiper = new Swiper(".swiper-container", {
     ...
     $( document ).ready(function() {
    	 ...
    	 mainAjax();
    	 //더보기 버튼을 누르면 인기상품이 3개씩 아래로 증가하는 로직
    	 $(".event-bu2").click(e=>{
    	 	$(".event-remove").remove(); 
    		type+=3;
    		mainAjax();
    	 });
    	 //해당 버튼을 누르면 해당 인기상품을 가져오는 로직
