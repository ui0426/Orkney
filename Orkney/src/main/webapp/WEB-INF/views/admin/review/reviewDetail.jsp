...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
	...
	<form action="${path}/admin/deleteReview" method="post">
		<input id="rNo" name="rNo" type="hidden" value="${r.review_no }"/>
		<input id="mNo" name="mNo" type="hidden" value="${r.member_no }"/>
		<c:forEach items="${r.riList }" var="ri">
			<input id="riName" name="riName" type="hidden" value="${ri.renamedFileName }"/>
		</c:forEach>
	</form>
