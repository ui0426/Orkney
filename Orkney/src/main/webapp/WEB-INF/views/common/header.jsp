    ...
    <header>
        ...
        <div class="header-container">
            ...
            <ul class="header-icons">
                ...
                <li class="header-icon">
                    <a href=""><span><svg aria-hidden="true" focusable="false" class="svg-icon  hnf-svg-icon hnf-svg-bag-default" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg" >
